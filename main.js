...
classifier= ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/B4jx6_hzX/model.json', modelLoaded)
...
function check() {
    ...
    if (error) {
        ...
        if (results[1].label == "Fingers Crossed") {
            document.getElementById("update_emoji_2").innerHTML= "&#129310";
